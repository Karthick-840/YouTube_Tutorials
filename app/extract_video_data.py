...
class Playlist_Info():
    ...
    def get_info(self):
        ...
        video_details = video_details.assign(
            Start_Date=None, Start_Time=None, Time_to_Spend=None)
    ...
    def get_video_data(url):
        ...
        try:
            ...
            video_runtime = Playlist_Info.convert_seconds_to_hms(yt.length)

        except VideoUnavailable:
            print(f'Video {url} is unavaialable, skipping.')
            return None

        except Exception as e:  # Catch other pytube errors
            print(f"Error getting video info from pytube: {e}")
            command = ["yt-dlp",
            ...
            try:
                ...
                # Convert to hms.
                video_runtime = Playlist_Info.convert_seconds_to_hms(
                    video.get('duration'))
            ...
            video_data = {"Video Title": video_title, "Run Time": video_runtime,
                          "Video Link": url, "Video Keywords": keywords_string}
    ...
    def extract_keywords(video_keywords):
        ...
        while bool(video_keywords):
            ...
            custom_stopwords = set(stopwords.words(
                "english") + ["for", "or", "and", "the", "is", "are", "it", "in", "on"])
